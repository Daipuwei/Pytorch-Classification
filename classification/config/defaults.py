...
# -----------------------------------------------------------------------------
_C.MODEL = CN()
_C.MODEL.META_ARCHITECTURE = "Classification"

# ---------------------------------------------------------------------------- #
# Backbone(Classification) options
# ---------------------------------------------------------------------------- #
_C.MODEL.BACKBONE = CN()
# 是否使用预训练权重
_C.MODEL.BACKBONE.PRETRAIN = False
# 预训练权重路径
_C.MODEL.BACKBONE.PRETRAIN_WEIGHT_PATH = ''
# 是否为评估测试阶段
_C.MODEL.BACKBONE.IS_EVAL = False
# 分类个数
_C.MODEL.BACKBONE.NUM_CLASSES = 1000
# backbone搭建函数名称
_C.MODEL.BACKBONE.NAME = "build_alexnet_backbone"

# ---------------------------------------------------------------------------- #
# AlexNet
# ---------------------------------------------------------------------------- #
_C.MODEL.BACKBONE.DROP_PROB = 0.5
_C.MODEL.BACKBONE.ACTIVITION_TYPE = 'ReLU'
